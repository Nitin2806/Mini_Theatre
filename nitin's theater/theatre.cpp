...

{
    ...
    case 1:
        ...
        cout<<"1.Bharat\t\t\t\t15:00\t\t\t01\n2.Housefull 4\t\t\t\t13:00\t\t\t03\n3.Gully Boy\t\t\t\t18:00\t\t\t10\n4.Notebook\t\t\t\t19:00\t\t\t14\n5.Badla\t\t\t\t\t14:00\t\t\t09\n";
        cin>>c;
        ...
        case 1:
     ...
     else if (payment=='C')
           {
            ...
            cout<<"\t\t**************************************************************************************";
            cout<<"\n\n\n\n\nThis ticket is for online purpose only.The transtion is done including all GST and Taxes according to form no:18";
    ...
    case 2:
        system("cls");
        cout<<"  Movies\t\t\t\tTiming\t\t\tSeat Available\n\n";
        cout<<"1.Avengers:End Game\t\t\t\t15:00\t\t\t00\n2.Captain Marvel\t\t\t\t13:00\t\t\t03\n3.The New Mutant\t\t\t\t18:00\t\t\t10\n4.Supernman vs Superwomen\t\t\t19:00\t\t\t14\n5.Spiderman:Far from home\t\t\t114:00\t\t\t10\n";
        cin>>c;
        switch(c)
        {
        case 1:
